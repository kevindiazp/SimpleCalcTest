...
public class CalculatorTest {
    ...
    public void subWorksWithNegativeResult() {
        double resultAdd = mCalculator.sub(1d, 17d);
        assertThat(resultAdd, is(equalTo(-16d)));
    }
    @Test
    public void mulTwoNumbers() {
        double resultAdd = mCalculator.mul(32d, 2d);
        assertThat(resultAdd, is(equalTo(64d)));
    }

    @Test
    public void divTwoNumbers() {
        double resultAdd = mCalculator.div(32d, 2d);
        assertThat(resultAdd, is(equalTo(16d)));
    }

    @Test
    public void divTwoNumbersZero() {
        double resultAdd = mCalculator.div(32d, 0d);
